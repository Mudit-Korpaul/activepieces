import { PipedriveEventAction, PipedriveEventObject } from '../common/models';
import { pipedriveRegisterTrigger } from './register-triggers';
export const pipedriveTriggers = [
  {
    name: 'new_activity',
    displayName: 'New Activity',
    description: 'Triggers when a new activity is added',
    eventObject: PipedriveEventObject.ACTIVITY,
    eventAction: PipedriveEventAction.ADDED,
    sampleData: {
      id: 8,
      company_id: 22122,
      user_id: 1234,
  ...
  },
  {
    ...
    eventObject: PipedriveEventObject.DEAL,
    eventAction: PipedriveEventAction.ADDED,
    sampleData: {
      id: 1,
      creator_user_id: {
  ...
  },
  {
    ...
    eventObject: PipedriveEventObject.PERSON,
    eventAction: PipedriveEventAction.ADDED,
    sampleData: {
      id: 1,
      company_id: 12,
  ...
  },
  {
    ...
    eventObject: PipedriveEventObject.DEAL,
    eventAction: PipedriveEventAction.UPDATED,
    sampleData: {
      id: 1,
      creator_user_id: {
        id: 8877,
...
].map((props) => pipedriveRegisterTrigger(props));
